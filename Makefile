NAME=eda9
OBJ=parameter.o result.o test.o individual.o nqueens_individual.o leading_individual.o onemax_individual.o onemax2_individual.o haystack_individual.o $(NAME).o

CPPFLAGS =
FLAGS = -O3 -pipe -ftracer -fmerge-all-constants -ffast-math -march=pentium4 -fmove-all-movables -fno-math-errno -ffinite-math-only -fno-trapping-math #--param max-crossjump-edges=2000 --param max-gcse-memory=209715200 --param max-gcse-passes=40 --param max-pending-list-length=1000 --param max-delay-slot-insn-search=2000 --param max-delay-slot-live-search=4000
#FLAGS = -O0 -pipe
