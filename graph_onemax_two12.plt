...
set title 'OneMax Two Peaks (alpha = 1.2, PopSize: 10)'
...
plot "graph_onemax_two/graph_onemax_two6_fitness.gnp" ti "No correction" with lines ls 1, "graph_onemax_two/graph_onemax_two7_fitness.gnp" ti "No correction + bounded" with lines ls 2, "graph_onemax_two/graph_onemax_two8_fitness.gnp" ti "Corrected distribution" with lines ls 3

set output "graph_onemax_two/graph_onemax_two003_fitness.png"
set title 'OneMax Two Peaks (alpha = 1.2, PopSize: 50)'
plot "graph_onemax_two/graph_onemax_two9_fitness.gnp" ti "No correction" with lines ls 1, "graph_onemax_two/graph_onemax_two10_fitness.gnp" ti "No correction + bounded" with lines ls 2, "graph_onemax_two/graph_onemax_two11_fitness.gnp" ti "Corrected distribution" with lines ls 3
...
set title 'OneMax Two Peaks (alpha = 1, PopSize: 50)'
plot "graph_onemax_two/graph_onemax_two6_diversity.gnp" ti "No correction" with lines ls 1, "graph_onemax_two/graph_onemax_two7_diversity.gnp" ti "No correction + bounded" with lines ls 2, "graph_onemax_two/graph_onemax_two8_diversity.gnp" ti "Corrected distribution" with lines ls 3

set output "graph_onemax_two/graph_onemax_two003_diversity.png"
set title 'OneMax Two Peaks (alpha = 1.2, PopSize: 50)'
plot "graph_onemax_two/graph_onemax_two9_diversity.gnp" ti "No correction" with lines ls 1, "graph_onemax_two/graph_onemax_two10_diversity.gnp" ti "No correction + bounded" with lines ls 2, "graph_onemax_two/graph_onemax_two11_diversity.gnp" ti "Corrected distribution" with lines ls 3
